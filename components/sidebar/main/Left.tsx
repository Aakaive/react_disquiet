    ...
    return (
        <div className="relative flex flex-col h-full mt-[24px] mb-[32px] gap-[32px]">
            ...
            <div className="sticky top-[92px] ">
                {/* 왼쪽 상자 */}
                <div className="items-center flex flex-col p-[8px] 
                    ...
                    <div className="flex flex-col w-full gap-[8px]">
                        ...
                        <div className="items-center flex gap-[4px] cursor-pointer">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                className="fill-[rgb(196,196,196)] transition-all transition-delay-0 transition-duration-100 ease-out cursor-pointer"
                            >

        ...
        <div className="relative items-start flex justify-between">
            <div className="flex">
                <div className="h-[42px] w-[42px] mr-[8px] ">
                    {/* 유저 프로필 사진 */}
                    <Link href={user?.profileImage || "#"}  className="flex flex-col h-[42px] w-[42px] mr-[8px] border-[rgba(0,0,0,0)] border-[1px] transition-all duration-400 ease-in-out rounded-[50%]">

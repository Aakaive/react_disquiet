...
const ViewPostMakerlog : React.FC<PostProps> = ({postNum}) => {
    ...
    return (
        <div className="flex flex-col mb-[40px] ml-[32px]">
            <div className="relative w-full">
                <div className="relative items-center flex flex-col px-[20px] pt-[20px] pb-[16px] bg-white transition-all duration-100 ease-out rounded-[20px] gap-[8px]
                    ...
                    <div className="relative items-center flex flex-col mb-[8px] w-full">
                        {/* 여기까지 */}
                        <div className="items-start flex justify-between w-full mb-[10px]">
                            {/* 제목 */}
                            <h1 className="overflow-hidden text-[24px] font-medium leading-[28.8px] ellipsis">{post?.title}</h1>
                        </div>
                        <div className="relative flex flex-col mb-[8px] overflow-hidden p-0 w-full h-[288px]">
...
export default ViewPostMakerlog;